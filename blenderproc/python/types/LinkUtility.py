...
class Link(Entity):
    ...
    def get_visual_local2world_mats(
        ...
        if self.visuals:
            # NOTE: debug hack to make things work
            if not self.set_link2bone_mat:
                return None
            link2base_mats = [
                bone_mat @ (self.link2bone_mat.inverted() @ visual_local2link_mat)
    ...
    def get_collision_local2world_mats(
        ...
        if self.collisions:
            link2base_mats = [
                bone_mat @ (self.link2bone_mat.inverted() @ collision_local2link_mat)
    ...
    def create_ik_bone_controller(
        ...
        bpy.context.view_layer.update()
        offset = (
            self.ik_bone_constraint.matrix.inverted() @ self.ik_bone_controller.matrix
        )
