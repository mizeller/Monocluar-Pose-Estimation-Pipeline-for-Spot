# Inspired by this jupyter notebook: https://www.kaggle.com/code/ericdepotter/visualize-coco-annotations
# Adapted for single class case to easily visualise all frames/annotations in the COCO format provided by BlenderProc2
...
class CocoDataset:
    ...
    def display_images(self):
        ...
        for image_id in self.images.keys():
            html = self.display_image(image_id)
            # Save HTML content to a file -> open img in browser
            with open(f"output_{image_id}.html", "w") as file:
                file.write(html)
...
def main():
    annotation_path = r"labels.json"
    image_dir = r"/Users/mizeller/projects/BlenderProc/coco_data"
    coco_dataset = CocoDataset(annotation_path, image_dir)
    coco_dataset.display_images()
